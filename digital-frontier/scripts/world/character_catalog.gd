...
const CHARACTERS: Dictionary = {
	...
	&"npc_villager": {"path": "humans/npc_villager.glb", "scale": 0.58, "y": 0.0, "category": &"npc", "role_hint": &"villager"},
	&"npc_merchant": {"path": "humans/npc_merchant.glb", "scale": 0.59, "y": 0.0, "category": &"npc", "role_hint": &"merchant"},
	&"npc_explorer": {"path": "humans/npc_explorer.glb", "scale": 0.59, "y": 0.0, "category": &"npc", "role_hint": &"explorer"},
	&"npc_researcher": {"path": "humans/npc_researcher.glb", "scale": 0.57, "y": 0.0, "category": &"npc", "role_hint": &"researcher"},
	&"npc_story": {"path": "humans/npc_story.glb", "scale": 0.59, "y": 0.0, "category": &"npc", "role_hint": &"story"},
	&"npc_guard": {"path": "humans/npc_guard.glb", "scale": 0.60, "y": 0.0, "category": &"npc", "role_hint": &"guard"},
