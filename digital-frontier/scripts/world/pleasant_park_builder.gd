...
static func _add_chests(root: Node3D, result: Dictionary) -> void:
	...
	var specs := [
		{"name": "Chest_0", "pos": Vector3(3.5, 0, 3.5), "rarity": ChestInteractable.Rarity.NORMAL},
		{"name": "Chest_1", "pos": Vector3(-12, 0, -22), "rarity": ChestInteractable.Rarity.NORMAL},
		{"name": "Chest_2", "pos": Vector3(27, 0, 12), "rarity": ChestInteractable.Rarity.RARE},
		{"name": "Chest_3", "pos": Vector3(0, 0, -40), "rarity": ChestInteractable.Rarity.NORMAL},
		{"name": "Chest_4", "pos": Vector3(42, 0, -5), "rarity": ChestInteractable.Rarity.NORMAL},
	]
	for spec in specs:
