...
const PROPS: Dictionary = {
	...
	&"tree_pine": {"path": "nature/tree_pine.glb", "scale": 3.2, "y": 0.0, "collision": true, "category": &"nature"},
	&"tree_oak": {"path": "nature/tree_oak.glb", "scale": 4.2, "y": 0.0, "collision": true, "category": &"nature"},
	&"tree_default": {"path": "nature/tree_default.glb", "scale": 3.6, "y": 0.0, "collision": true, "category": &"nature"},
	&"bush": {"path": "nature/bush.glb", "scale": 2.2, "y": 0.0, "collision": false, "category": &"nature"},
	...
	&"sofa": {"path": "interior/sofa.glb", "scale": 1.5, "y": 0.0, "collision": true, "category": &"interior"},
	&"coffee_table": {"path": "interior/coffee_table.glb", "scale": 1.45, "y": 0.0, "collision": true, "category": &"interior"},
	&"chair": {"path": "interior/chair.glb", "scale": 1.45, "y": 0.0, "collision": true, "category": &"interior"},
	&"desk": {"path": "interior/desk.glb", "scale": 1.45, "y": 0.0, "collision": true, "category": &"interior"},
	&"bookcase": {"path": "interior/bookcase.glb", "scale": 1.5, "y": 0.0, "collision": true, "category": &"interior"},
	&"fridge": {"path": "interior/fridge.glb", "scale": 1.55, "y": 0.0, "collision": true, "category": &"interior", "tint": Color(0.75, 0.78, 0.82)},
	&"stove": {"path": "interior/stove.glb", "scale": 1.5, "y": 0.0, "collision": true, "category": &"interior", "tint": Color(0.35, 0.36, 0.4)},
	&"sink": {"path": "interior/sink.glb", "scale": 1.45, "y": 0.0, "collision": true, "category": &"interior", "tint": Color(0.82, 0.85, 0.88)},
	&"toilet": {"path": "interior/toilet.glb", "scale": 1.4, "y": 0.0, "collision": true, "category": &"interior", "tint": Color(0.9, 0.92, 0.94)},
	&"television": {"path": "interior/television.glb", "scale": 1.4, "y": 0.0, "collision": false, "category": &"interior"},
	&"potted_plant": {"path": "interior/potted_plant.glb", "scale": 1.4, "y": 0.0, "collision": false, "category": &"interior"},
	&"floor_lamp": {"path": "interior/floor_lamp.glb", "scale": 1.45, "y": 0.0, "collision": false, "category": &"interior"},
	## Adventure
	...
	&"craft_speeder": {"path": "transport/craft_speeder.glb", "scale": 2.4, "y": 0.2, "collision": true, "category": &"transport", "mesh_yaw": 180.0, "tint": Color(0.35, 0.7, 0.85)},
	&"craft_speeder_alt": {"path": "transport/craft_speeder_alt.glb", "scale": 2.4, "y": 0.2, "collision": true, "category": &"transport", "mesh_yaw": 180.0, "tint": Color(0.85, 0.55, 0.25)},
